"""Dataset class for loading and batching training data."""
...
from performance_rnn_torch.core.sequence import ControlSeq
...
class Dataset:
    def __init__(self, root, verbose=False):
        ...
        paths = helpers.find_files_by_extensions(root, ['.data'])
        self.root = root
        self.samples = []
        self.seqlens = []
        if verbose:
